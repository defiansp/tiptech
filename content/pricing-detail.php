<!-- Comparison Table -->
<div class="relative">
    <div class="max-w-screen-xl px-4 py-10 sm:px-6 lg:px-8 md:py-14 lg:py-20 mx-auto">
        <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
            <h2 class="text-2xl font-bold md:text-3xl md:leading-tight dark:text-white">Bandingkan fiturnya, pilih yang paling cocok untuk bisnis anda.</h2>
        </div>

        <!-- Header -->
        <div class="hidden lg:block sticky top-[68px] start-0 py-2 bg-white/60 backdrop-blur-md dark:bg-neutral-900/60">
            <!-- Grid -->
        ...
        <div class="space-y-4 lg:space-y-0">
            <!-- List -->
            <ul class="grid lg:grid-cols-5 lg:gap-6">
                <!-- Item -->
        ...
        <div class="hidden lg:block mt-6">
            ...
            <div class="grid grid-cols-5 gap-6">
                ...
                <div class="col-span-1">
                    <a href="https://wa.me/6287737416923?text=Halo,%20saya%20tertarik%20dengan%20produk%20POS%20Resto." class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-primary text-white dark:bg-secondary hover:bg-gray-700 focus:outline-hidden focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none" href="#">
                        Coba Sekarang
                    </a>
                </div>
                <!-- End Col -->
