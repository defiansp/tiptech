  ...
  <div class="max-w-screen-xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    ...
    <div class="mx-auto max-w-2xl mb-8 lg:mb-14 text-center">
      <h2 class="text-3xl lg:text-4xl text-gray-800 font-bold dark:text-neutral-200">
        Apapun bisnis anda, kami punya solusinya.
      </h2>
    </div>
    <!-- End Title -->
    ...
    <div class="relative xl:w-10/12 xl:mx-auto">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
        <div>
          ...
          <div class="p-4 relative z-10 bg-white border border-gray-200 rounded-xl md:p-10 dark:bg-neutral-900 dark:border-neutral-800">
            <h3 class="text-xl font-bold text-gray-800 dark:text-neutral-200">Point of Sales Standard</h3>
            <div class="text-sm text-gray-500 dark:text-neutral-500">Cocok untuk UMKM atau bisnis apapun.</div>

            <div class="mt-5">
              <span class="text-5xl font-extrabold text-gray-800 dark:text-neutral-200">Rp200.000</span>
              <span class="text-gray-500 dark:text-neutral-500">/ bulan</span>
            </div>
        ...
        <div>
          ...
          <div class="shadow-xl shadow-gray-200 p-5 relative z-10 bg-white border border-gray-200 rounded-xl md:p-10 dark:bg-neutral-900 dark:border-neutral-800 dark:shadow-gray-900/20">
            <h3 class="text-xl font-bold text-gray-800 dark:text-neutral-200">Point of Sales for Restaurant</h3>
            <div class="text-sm text-gray-500 dark:text-neutral-500">Cocok untuk bisnis Restoran atau Cafe.</div>
            <span class="absolute top-0 end-0 rounded-se-xl rounded-es-xl text-xs font-medium  bg-primary text-white dark:bg-secondary dark:text-primary hover:bg-neutral-800 dark:hover:bg-white py-1.5 px-3">Most popular</span>

            <div class="mt-5">
              <span class="text-5xl font-extrabold text-gray-800 dark:text-neutral-200">Rp350.000</span>
              <span class="text-gray-500 dark:text-neutral-500">/ bulan</span>
            </div>
      ...
      <div class="hidden md:block absolute bottom-0 start-0 translate-y-16 -translate-x-16">
        <svg class="w-56 h-auto text-primary dark:text-white" width="347" height="188" viewBox="0 0 347 188" fill="none" xmlns="http://www.w3.org/2000/svg">
