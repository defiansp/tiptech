  ...
  <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-24">
    <div class="text-center">
      ...
      <p class="mt-3 text-gray-600 dark:text-neutral-400">
        Kami adalah Solusi Kebutuhan Bisnis Anda
      </p>
      ...
      <div class="mt-7 sm:mt-12 mx-auto max-w-xl relative">
        ...
        <form>
          <div
            ...
            <p class="w-full mt-3 text-gray-600 dark:text-neutral-400">
              Build your dream project with Us
            </p>
            <div>
              <a class="size-11 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-primary dark:bg-secondary text-white dark:text-neutral-800 hover:bg-neutral-700 disabled:opacity-50 disabled:pointer-events-none"
                href="https://mail.google.com/mail/?view=cm&fs=1&to=cs@tigaintiperkasa.co.id" target="_blank" rel="noopener noreferrer">
        ...
        <div class="hidden md:block absolute top-0 end-0 -translate-y-12 translate-x-20">
          <svg class="w-16 h-auto text-primary dark:text-white" width="121" height="135" viewBox="0 0 121 135"
        ...
        <div class="hidden md:block absolute bottom-0 start-0 translate-y-10 -translate-x-32">
          <svg class="w-40 h-auto text-secondary" width="347" height="188" viewBox="0 0 347 188"
            fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
...
<!-- ========== FOOTER ========== -->
<footer class="mt-8 w-full max-w-screen-xl py-10 px-4 sm:px-6 lg:px-8 mx-auto">
  <!-- Grid -->
    ...
    <div class="flex flex-wrap justify-between items-center gap-3">
      <div class="mt-3 md:hidden">
        ...
        <p class="mt-1 text-xs sm:text-sm text-gray-400 dark:text-neutral-400">
          © Copyright 2025 PT Tiga Inti Perkasa Tech. All Rights Reserved.
        </p>
      </div>

      <!-- Copyright -->
      <p class="hidden md:block mt-1 text-xs sm:text-sm text-gray-400 dark:text-neutral-400">
        © Copyright 2025 PT Tiga Inti Perkasa Tech. All Rights Reserved.
      </p>

      <!-- Social Brands -->
      <div class="hidden md:block space-x-4">
        <a class="inline-block text-gray-500 hover:text-gray-800 focus:outline-hidden focus:text-gray-800 dark:text-neutral-500 dark:hover:text-neutral-200 dark:focus:text-neutral-200" href="https://wa.me/6287737416923" target="_blank">
          <svg class="shrink-0 w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
        ...
        <a class="inline-block text-gray-500 hover:text-gray-800 focus:outline-hidden focus:text-gray-800 dark:text-neutral-500 dark:hover:text-neutral-200 dark:focus:text-neutral-200" href="https://www.instagram.com/tigaintiperkasa/" target="_blank">
          <svg class="shrink-0 w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
