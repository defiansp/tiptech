...
<body class="font-sans antialiased bg-white dark:bg-neutral-800 scroll-smooth">
    ...
    <div id="loading"
        class="fixed inset-0 bg-primary dark:bg-neutral-800 flex items-center justify-center z-50 opacity-100 scale-100
            transition-all duration-100 ease-in-out will-change-opacity will-change-transform">
    ...
    <!-- Main Content -->
    <div id="content" class="opacity-0 transition-opacity duration-100 delay-100">
        ...
        <!-- Footer -->
        <?php include __DIR__ . '/../layouts/simple-footer.php'; ?>
